...
def main():
    ...
    commands = [        
        ...
        {"description": "Limpar resultados antigos no diretório de metadados",
         ...
         {"description": "Executar CPPred-SORF.py",
         "directory": "ferramentas/CPPred-sORF/CPPred-sORF/",
         "cmd": "python CPPred-sORF.py -i ../../../metadata/{{experiment_name}}.fasta  -hex Hexamer/Integrated_Hexamer.txv -r Model/Integrated.range -mol Model/Integrated.model -spe Integrated -o {{experiment_name}}_"+name_tool+".txt"},
        {"description": "Mover novos resultados para o diretório de metadados",
         "directory": "ferramentas/CPPred-sORF/",
         "conda":"ferramentas",
