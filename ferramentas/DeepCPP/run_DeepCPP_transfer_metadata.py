...
parser = argparse.ArgumentParser(description="Corrige CSV e adiciona cabe�alho.")
...
arquivo_entrada = os.path.join('DeepCPP','output_files', f'{args.input}')
...
with open(arquivo_entrada, "r", encoding="utf-8") as infile, open(arquivo_saida, "w", newline="", encoding="utf-8") as outfile:
    ...
    # Cabe�alho
    escritor.writerow(["orf_name", "value", "nt_orf_sequence", "result"])
